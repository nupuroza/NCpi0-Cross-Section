void makeXsecErrorSummary(){
    ...
    std::vector<double> uncertainty_total     = {0.16085,0.24458,0.24194};
    std::vector<double> uncertainty_stat      = {0.06090,0.10640,0.11965};
    std::vector<double> uncertainty_detector  = {0.04075,0.08157,0.06775};
    std::vector<double> uncertainty_flux      = {0.11561,0.13408,0.13218};
    std::vector<double> uncertainty_geant4    = {0.01507,0.02327,0.01700};
    std::vector<double> uncertainty_genie     = {0.08005,0.15109,0.14617};
    std::vector<double> uncertainty_pot       = {0.02001,0.02001,0.02001};
    std::vector<double> uncertainty_targets   = {0.01000,0.01000,0.01000};
    ...
    l->AddEntry(tHist_dummy,"#splitline{Semi-inclusive}{NC 1 #pi^{0}}","lp");
