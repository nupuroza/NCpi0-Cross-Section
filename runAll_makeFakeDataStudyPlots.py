...
for config in configs_to_run:
  ...
  file_to_process = "{0}/{1}_out_unfolded_{2}_xsec-extracted.root".format(inFileDir,date_string,config)
  plotDir = "{0}/{1}_xsec-plots_{2}/".format(inFileDir,date_string,config)
  command_string = "python makeFakeDataStudyPlots.py {0} {1}".format(file_to_process,plotDir)
