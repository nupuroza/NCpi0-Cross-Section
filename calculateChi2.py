...
def calculateChi2(mc_hist, data_hist, cov_matrix, cov_matrix_includes_stats):
    cov_matrix_with_stat = cov_matrix.Clone("cov_matrix_with_stat")
    ...
    if nbins + 1 != cov_matrix_with_stat.GetNrows() or nbins + 1 != cov_matrix_with_stat.GetNcols():
        print("nbins + 1: " + str(nbins + 1))
        print("cov_matrix_with_stat_rows: " + str(cov_matrix_with_stat.GetNrows()))
        print("cov_matrix_with_stat_cols: " + str(cov_matrix_with_stat.GetNcols()))
