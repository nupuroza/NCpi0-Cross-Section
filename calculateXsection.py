...
tHist2D_cov_evtRate_2gnp_inclusive_unfolded = unfoldedFile.Get("unf_cov")
tHist2D_cov_evtRate_2gnp_inclusive_unfolded.SetName("unfolded_cov_evtRate_2gnp_inclusive")   
...
writeHist(tHist2D_cov_evtRate_2gnp_inclusive_unfolded,histFile)
